...
int main(int argc, char **argv ){
  MPI_Init( &argc , &argv);
  int id, i,j, np, n, ind, gap, inicio, fin, num_elems_rango, num_primos_local = 0,num_primos=0;
  ...
  MPI_Reduce(&num_primos_local, &num_primos, 1, MPI_INT, MPI_SUM, 0, MPI_COMM_WORLD);
